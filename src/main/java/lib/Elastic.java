...
public final class Elastic {
    ...
    private static final NetworkTable rootTable = NetworkTableInstance.getDefault().getTable("/Elastic");
    private static final StringTopic notificationTopic =
        rootTable.getStringTopic("RobotNotifications");
    ...
    private static final StringTopic selectedTabTopic =
        rootTable.getStringTopic("SelectedTab");
