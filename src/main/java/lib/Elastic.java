...
//TODO: Add methods to publish data to NT root table
public final class Elastic {
    
    private static Elastic instance;
    
    private final NetworkTable rootTable;
    private final StringTopic notificationTopic;
    private final StringPublisher notificationPublisher ;
    private final StringTopic selectedTabTopic;
    private final StringPublisher selectedTabPublisher;
    private final ObjectMapper objectMapper = new ObjectMapper();

    private Elastic() {
        rootTable = NetworkTableInstance.getDefault().getTable("/Elastic");
        notificationTopic = rootTable.getStringTopic("RobotNotifications");
        notificationPublisher = notificationTopic.publish(PubSubOption.sendAll(true), PubSubOption.keepDuplicates(true));
        selectedTabTopic = rootTable.getStringTopic("SelectedTab");
        selectedTabPublisher = selectedTabTopic.publish(PubSubOption.keepDuplicates(true));
    }
